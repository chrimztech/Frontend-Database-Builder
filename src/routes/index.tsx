            ...
            <div className="grid gap-10 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
              <div className="text-white">
                ...
                <p className="mt-5 max-w-2xl text-base leading-7 text-white/76 sm:text-lg">
                  Confirm whether a certificate was genuinely issued by {ORG_NAME}. This
                  portal is designed for employers, institutions, regulators, and any
                  reviewer who needs a quick, trustworthy answer.
                </p>
                ...
                <div className="mt-10 grid gap-4 sm:grid-cols-3">
                  ...
                  <MetricCard
                    icon={Building2}
                    value="Institution"
                    label="issued records only"
                  />
                  <MetricCard
                    icon={QrCode}
                    value="QR"
                    label="ready verification flow"
                  />
                </div>
              </div>
              ...
              <div className="surface-panel rounded-[1.9rem] p-6 sm:p-8">
                ...
                >
                  <Input
                    ...
                    className="h-12 font-mono text-sm uppercase tracking-[0.18em]"
                  />
          ...
          <div className="grid gap-6 lg:grid-cols-[0.92fr_1.08fr]">
            <div className="surface-panel rounded-[1.75rem] p-6 sm:p-8">
              ...
              <p className="mt-3 text-sm leading-6 text-muted-foreground">
                If a certificate cannot be located, looks suspicious, or needs a manual
                review, contact the issuing office before accepting or rejecting it.
              </p>
            ...
            <div className="surface-panel rounded-[1.75rem] p-6 sm:p-8">
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-3">
                {verificationSteps.map(({ step, title, body }) => (
                  <div key={step} className="rounded-[1.35rem] border border-border/70 bg-white/70 p-5 shadow-[var(--shadow-soft)]">
